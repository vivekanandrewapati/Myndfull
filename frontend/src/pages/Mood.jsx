                            ...
                            <div className="space-y-4">
                                {moodHistory.length > 0 ? (
                                    moodHistory.map((entry) => (
                                        <div
                                            key={entry._id}
                                            className={`border-b pb-4 rounded-lg p-3 font-body text-800 ${moodOptions.find(m => m.value === entry.mood)?.color} break-words`}
                                        >
                                            ...
                                            {entry.journal && (
                                                <p className="text-sm text-primary-800 mb-2 break-words">{entry.journal}</p>
                                            )}
                                        </div>
                                    ))
                                ) : (
