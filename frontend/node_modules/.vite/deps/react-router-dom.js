...
var DeferredData = class {
  constructor(data, responseInit) {
    ...
    let reject;
    this.abortPromise = new Promise((_2, r) => reject = r);
...
var NavigationContext = J(null);
if (true) {
  NavigationContext.displayName = "Navigation";
}
var LocationContext = J(null);
if (true) {
...
function useOutlet(context) {
  ...
  if (outlet) {
    return g(OutletContext.Provider, {
      value: context
    }, outlet);
  }
  return outlet;
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  if (locationArg && renderedMatches) {
    return g(LocationContext.Provider, {
      value: {
        location: _extends2({
          pathname: "/",
          search: "",
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = g(k, null, g("p", null, "💿 Hey developer 👋"), g("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", g("code", {
      style: codeStyles
    }, "ErrorBoundary"), " or", " ", g("code", {
      style: codeStyles
    }, "errorElement"), " prop on your route."));
  }
  return g(k, null, g("h2", null, "Unexpected Application Error!"), g("h3", {
    style: {
      fontStyle: "italic"
    }
  }, message), stack ? g("pre", {
...
var RenderErrorBoundary = class extends x {
  ...
  render() {
    return this.state.error !== void 0 ? g(RouteContext.Provider, {
      value: this.props.routeContext
    }, g(RouteErrorContext.Provider, {
...
function RenderedRoute(_ref) {
  ...
  return g(RouteContext.Provider, {
    value: routeContext
  }, children);
}
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? g(RenderErrorBoundary, {
...
function useMatches() {
  ...
  return T(() => matches.map((m) => convertRouteMatchToUiMatch(m, loaderData)), [matches, loaderData]);
}
...
function MemoryRouter(_ref3) {
  ...
  y(() => logV6DeprecationWarnings(future), [future]);
  return g(Router, {
    basename,
    children,
    location: state.location,
...
function Router(_ref5) {
  ...
  return g(NavigationContext.Provider, {
    value: navigationContext
  }, g(LocationContext.Provider, {
    children,
...
function Await(_ref7) {
  ...
  return g(AwaitErrorBoundary, {
    resolve,
    errorElement
  }, g(ResolveAwait, null, children));
}
...
var AwaitErrorBoundary = class extends x {
  ...
  render() {
    ...
    if (status === AwaitRenderStatus.error) {
      return g(AwaitContext.Provider, {
        value: promise,
        children: errorElement
      });
    }
...
var FetchersContext = J(/* @__PURE__ */ new Map());
if (true) {
...
function RouterProvider(_ref) {
  ...
  y(() => logV6DeprecationWarnings(future, router.future), [future, router.future]);
  return g(k, null, g(DataRouterContext.Provider, {
    value: dataRouterContext
  }, g(DataRouterStateContext.Provider, {
    value: state
  }, g(FetchersContext.Provider, {
    value: fetcherData.current
  }, g(ViewTransitionContext.Provider, {
    value: vtContext
  }, g(Router, {
    basename,
    location: state.location,
    ...
    navigator,
    future: routerFuture
  }, state.initialized || router.future.v7_partialHydration ? g(MemoizedDataRoutes, {
...
var Link = D(function LinkWithRef(_ref7, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
var NavLink = D(function NavLinkWithRef(_ref8, ref) {
  let {
...
function useFetcher(_temp3) {
  ...
  let FetcherForm = T(() => {
    let FetcherForm2 = D((props, ref) => {
      return g(Form, _extends3({}, props, {
        navigate: false,
        fetcherKey,
        ref
      }));
